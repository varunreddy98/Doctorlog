...
public class inform extends AppCompatActivity implements View.OnClickListener,AdapterView.OnItemSelectedListener{
   ...
   static String fn2,ln2,spec2,phn2;
    ...
    EditText txt,edt;
    String des[]={"Cardiologist","Dentist","General Physician","Orthopaedician","Pediatrician","Dermatologist","Neurologist"};
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.next1:
                ...
                if(lname.equals(""))
                {
                    EditText editText4 = (EditText) findViewById(R.id.lname);
               ...
               // String  date=String.valueOf(((EditText)findViewById(R.id.textdate)).getText());
                ...
                if(sp==0) {
                    ...
                    db.child("specialisation").setValue(spec1);
