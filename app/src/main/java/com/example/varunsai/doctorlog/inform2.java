...
public class inform2 extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db= FirebaseDatabase.getInstance().getReference("doctor").child(previously);
        ...
        bt.setOnClickListener(new View.OnClickListener() {
                                  ...
                                  public void onClick(View view) {
                                      ...
                                      EditText t1=(EditText)findViewById(R.id.degree);
                                      String degree=t1.getText().toString();
                                      if(degree.equals(""))
                                      {    deg1=degree;
                                          t1.setError("this field is necessary");
                                          sp++;
                                      }

                                      EditText t2=(EditText)findViewById(R.id.exp);
                                      String exp=t2.getText().toString();
                                      if(exp.equals(""))
                                      {    exp1=exp;
                                          t2.setError("this field is necessary");
                                          sp++;
                                      }
                                      //otp later;
                                      if(sp==0) {
                                          db.child("degree").setValue(degree);
                                          db.child("experience").setValue(exp);
                                          db.child("clinics").setValue("null");
